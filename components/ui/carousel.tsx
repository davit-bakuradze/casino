...
function CarouselPrevious({ className, variant = 'outline', size = 'icon', ...props }: React.ComponentProps<typeof Button>) {
   ...
   return (
      <Button
         ...
         {...props}
      >
         <Image src={arrowNext} alt='arrow-right' width={21} height={21} className='w-3 h-3 lg:w-5 lg:h-5 rotate-180' />
...
function CarouselNext({ className, variant = 'outline', size = 'icon', ...props }: React.ComponentProps<typeof Button>) {
   ...
   return (
      <Button
         ...
         {...props}
      >
         <Image src={arrowNext} alt='arrow-right' width={21} height={21} className='w-3 h-3 lg:w-5 lg:h-5' />
